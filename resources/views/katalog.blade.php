            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4 d-flex">
                    <div class="card-item">
                        ...
                        <p class="catalog-detail"><??></p>
                        <p class="catalog-detail"><b>Rp<??>/day</b></p>
                        <div class="row align-items-center">
                            <div class="col">
                                <button type="button" class="btn btn-secondary w-100" onclick="showDetail('detailCard<??>')">
                                    More Detail
                                </button>
                            </div>
                            <div class="col-auto">
                                <li class="icon">
                                    <a href="keranjang.php?id_produk=<??>">
       ...
       <!-- Card Detail Produk -->
            <div id="detailCard<??>" class="detail-card" style="display: none;">
                <div class="detail-content">
                    <div class="row">
                        <div class="col-md-6">
                            <img src="../assets/foto_produk/<??>" alt="<??>" class="img-fluid rounded">
                        </div>
                        <div class="col-md-6">
                            <h4><??></h4>
                            <p><strong>Ukuran Produk:</strong> <??></p>
                            <p><strong>Stok Produk:</strong> <??></p>
                            <p><strong>Deskripsi:</strong> <??></p>
                            <p><strong>Harga:</strong> Rp<??>/day</p>
                            <div class="d-flex justify-content-between">
                                <!-- Adjust button size with custom classes or inline styles -->
                                <button class="btn btn-secondary btn-sm" onclick="closeDetail('detailCard<??>')">Tutup</button>
                                <a href="keranjang.php?id_produk=<??>" class="btn btn-primary btn-sm">Tambahkan ke Keranjang</a>
                            </div>
                        </div>
                    </div>
                </div>
